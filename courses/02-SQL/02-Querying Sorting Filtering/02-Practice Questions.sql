-- ============================================================
--  ASSIGNMENT 02 — Querying, Sorting & Filtering
--  Database : BikeStores
...
ORDER BY 
	list_price ASC;
-- 17 Rows will be return:
-- Formula: (Total Rows * Percentage) / 100 = (321 * 5) / 100 = 16.5
-- But result will be round up.
...
FROM 
	production.products 
ORDER BY 
	list_price DESC OFFSET 0 ROWS FETCH NEXT 10 ROWS ONLY;
...
FROM 
	production.products 
ORDER BY 
	list_price DESC OFFSET 10 ROWS FETCH NEXT 10 ROWS ONLY;
...
FROM 
	production.products 
ORDER BY 
	list_price DESC OFFSET 20 ROWS FETCH NEXT 10 ROWS ONLY;
...
FROM 
	production.products 
WHERE 
	(list_price >= 500 AND list_price <= 1500)
	AND (model_year = 2016 OR model_year = 2018)
ORDER BY 
	list_price ASC;